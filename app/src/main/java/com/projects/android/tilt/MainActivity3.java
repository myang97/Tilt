...
public class MainActivity3 extends Activity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        animatedView = new AnimatedView(MainActivity3.this);
    ...
    public class AnimatedView extends ImageView {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            canvas.drawText(" Level 3", phoneWidth / 3, phoneHeight / 3 + 420, paint);
            ...
            if (complete && !fail && !stop){
                ...
                paint.setTextSize(140);
                paint.setColor(Color.MAGENTA);
                canvas.drawText("CONGRATULATIONS!", phoneWidth / 12 - 20, phoneHeight / 3, paint);
                canvas.drawText("YOU BEAT THE GAME!", phoneWidth / 12 - 40, phoneHeight / 3 + 140, paint);
                canvas.drawText("Tap Here to Return", phoneWidth / 12, phoneHeight - 240, paint);
                buttonActivate = true;
            }
